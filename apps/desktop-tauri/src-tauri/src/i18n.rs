...
fn zh(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::TrayWebPortLabel => "Web 端口（当前 {0}）",
        Msg::TrayWebPortDefault => "默认 (3080)",
        Msg::TrayWebPortCustom => "自定义端口…",
        Msg::TrayOpenLog => "查看错误日志",
        Msg::TrayUpdate => "检查更新",
        Msg::TrayRestart => "重启",
        ...
        Msg::WebPortRestart => "Web 端口将在重启后生效",
        Msg::WebPortSaveFailed => "保存 Web 端口失败",
        Msg::LogMissing => "错误日志尚未生成",
        Msg::LogOpenFailed => "打开错误日志失败",
...
fn en(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::TrayWebPortLabel => "Web port (current {0})",
        Msg::TrayWebPortDefault => "Default (3080)",
        Msg::TrayWebPortCustom => "Custom port…",
        Msg::TrayOpenLog => "View error log",
        ...
        Msg::WebPortRestart => "The web/GUI port takes effect after restart",
        Msg::WebPortSaveFailed => "Could not save the web port",
        Msg::LogMissing => "No error log yet",
        Msg::LogOpenFailed => "Could not open the error log",
